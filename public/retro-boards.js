...
var $author$project$Main$ViewingLoading = {$: 'ViewingLoading'};
var $author$project$Main$ViewingCreateAccount = function (a) {
	return {$: 'ViewingCreateAccount', a: a};
};
var $author$project$Main$ViewingHome = {$: 'ViewingHome'};
var $author$project$Main$ViewingSignIn = function (a) {
	return {$: 'ViewingSignIn', a: a};
};
...
var $author$project$Route$CreateAccount = {$: 'CreateAccount'};
...
var $author$project$Route$slugs = {createAccount: 'create-account', landingPage: 'home', signIn: 'sign-in'};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$elm$url$Url$Parser$s($author$project$Route$slugs.landingPage)),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$CreateAccount,
			$elm$url$Url$Parser$s($author$project$Route$slugs.createAccount)),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$SignIn,
			$elm$url$Url$Parser$s($author$project$Route$slugs.signIn))
		]));
var $author$project$Route$fromUrl = $elm$url$Url$Parser$parse($author$project$Route$parser);
var $author$project$Page$CreateAccount$Model = {$: 'Model'};
var $author$project$Page$CreateAccount$init = $author$project$Page$CreateAccount$Model;
var $author$project$Page$SignIn$Model = {$: 'Model'};
var $author$project$Page$SignIn$init = $author$project$Page$SignIn$Model;
					...
					state: function () {
						...
						if (_v0.$ === 'Just') {
							switch (_v0.a.$) {
								case 'Home':
									var _v1 = _v0.a;
									return $author$project$Main$ViewingHome;
								case 'CreateAccount':
									var _v2 = _v0.a;
									return $author$project$Main$ViewingCreateAccount($author$project$Page$CreateAccount$init);
								default:
									var _v3 = _v0.a;
									return $author$project$Main$ViewingSignIn($author$project$Page$SignIn$init);
							}
						} else {
							return _Debug_todo(
								'Main',
...
var $author$project$Main$init = F3(
	function (_v0, url, navKey) {
		return A2(
			...
			url,
			{navKey: navKey, state: $author$project$Main$ViewingLoading});
	});
...
var $author$project$Main$CreateAccountMsg = function (a) {
	return {$: 'CreateAccountMsg', a: a};
};
...
var $author$project$Page$CreateAccount$update = F3(
	function (on, msg, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
var $author$project$Page$SignIn$update = F3(
	function (on, msg, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
	...
	function (msg, model) {
		...
		while (true) {
			switch (_v0.a.$) {
					...
					return _Utils_Tuple2(
						...
						function () {
							if (urlRequest.$ === 'Internal') {
								...
								var externalUrlStr = urlRequest.a;
								return A2($elm$browser$Browser$Navigation$replaceUrl, model.navKey, externalUrlStr);
							}
						}());
				case 'UrlChanged':
					var url = _v0.a.a;
					return A2($author$project$Main$urlChange, url, model);
				case 'CreateAccountMsg':
					if (_v0.b.$ === 'ViewingCreateAccount') {
						var createAccountMsg = _v0.a.a;
						var createAccountModel = _v0.b.a;
						var _v2 = A3($author$project$Page$CreateAccount$update, $author$project$Main$CreateAccountMsg, createAccountMsg, createAccountModel);
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									state: $author$project$Main$ViewingCreateAccount(updatedModel)
								}),
							cmd);
					} else {
						break _v0$4;
				...
				default:
					if (_v0.b.$ === 'ViewingSignIn') {
						var signInMsg = _v0.a.a;
						var signInModel = _v0.b.a;
						var _v3 = A3($author$project$Page$SignIn$update, $author$project$Main$SignInMsg, signInMsg, signInModel);
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									state: $author$project$Main$ViewingSignIn(updatedModel)
								}),
							cmd);
					} else {
						break _v0$4;
...
var $author$project$Components$globalLayout = $mdgriffith$elm_ui$Element$layout(
	_List_fromArray(
		[
...
var $author$project$Components$heading1 = function (str) {
...
var $author$project$Route$toUrlString = function (route) {
	return '/' + function () {
		switch (route.$) {
			case 'Home':
				return $author$project$Route$slugs.landingPage;
			case 'CreateAccount':
				return $author$project$Route$slugs.createAccount;
			default:
				return $author$project$Route$slugs.signIn;
		}
	}();
};
var $author$project$Page$CreateAccount$view = F2(
	function (on, model) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Components$heading1('Create Account'),
					A2(
					$mdgriffith$elm_ui$Element$link,
					_List_Nil,
					{
						label: $mdgriffith$elm_ui$Element$text('Go to home'),
						url: $author$project$Route$toUrlString($author$project$Route$Home)
					})
				]));
	});
var $author$project$Page$Home$view = A2(
	...
	_List_fromArray(
		[
			$author$project$Components$heading1('Home'),
			A2(
			$mdgriffith$elm_ui$Element$link,
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('Go to create account'),
				url: $author$project$Route$toUrlString($author$project$Route$CreateAccount)
			}),
			A2(
			$mdgriffith$elm_ui$Element$link,
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('Go to sign in'),
				url: $author$project$Route$toUrlString($author$project$Route$SignIn)
			})
		]));
...
var $author$project$Page$Loading$view = A2(
...
var $author$project$Page$SignIn$view = F2(
	function (on, model) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Components$heading1('Sign in'),
					A2(
					$mdgriffith$elm_ui$Element$link,
					_List_Nil,
					{
...
var $author$project$Main$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$Components$globalLayout(
				function () {
					var _v0 = model.state;
					switch (_v0.$) {
						case 'ViewingLoading':
							return $author$project$Page$Loading$view;
						case 'ViewingHome':
							return $author$project$Page$Home$view;
						case 'ViewingCreateAccount':
							var createAccountModel = _v0.a;
							return A2($author$project$Page$CreateAccount$view, $author$project$Main$CreateAccountMsg, createAccountModel);
						default:
							var signInModel = _v0.a;
							return A2($author$project$Page$SignIn$view, $author$project$Main$SignInMsg, signInModel);
					}
				}())
			]),
		title: 'BestRetro'
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UrlRequested":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"CreateAccountMsg":["Page.CreateAccount.Msg"],"SignInMsg":["Page.SignIn.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.CreateAccount.Msg":{"args":[],"tags":{"Msg":[]}},"Page.SignIn.Msg":{"args":[],"tags":{"Msg":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});
